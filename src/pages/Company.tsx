  ...
  return (
    <div className=" static w-full flex flex-col items-center px-[164px]">
      ...
      <div className="relative w-full h-[640px] bg-main rounded-lg">
        <img src={oval_gradient} alt="gradient" className="absolute right-0" />
        <img src={phone} alt="phone" className="absolute right-0 bottom-0" />
      ...
      <div className="w-full mt-[160px] text-white  h-[640px]  rounded-lg mb-10 grid grid-rows-2 grid-flow-col gap-[30px]">
        <div
          ...
          style={{ backgroundImage: `url(${web_design})` }}
        >
          <a
            href="/web_design"
        ...
        <div
          className="col-span-1 row-span-1 hover:opacity-25 h-full bg-no-repeat bg-cover w-full rounded-lg flex flex-col justify-center items-center"
          style={{ backgroundImage: `url(${app_design})` }}
        >
          <a href="/app_design">
            <p className="font-medium  leading-7 text-[40px] font-['Jost'] ">
              App Design
        ...
        <div
          className="row-span-1 col-span-1 hover:opacity-25 mix-blend-multiply h-full bg-no-repeat bg-cover w-full rounded-lg flex flex-col justify-center items-center"
          style={{ backgroundImage: `url(${graphic_design})` }}
        >
      ...
      <div className="grid grid-cols-3 gap-[30px] mt-[160px] mb-[380px]">
        {Qualities.map((value) => (
          <div className="flex flex-col leading-[26px] text-[#333136] h-[412px] items-center">
            ...
            <p className="text-center mt-[32px]  text-[16px]">{value.body}</p>
          </div>
        ))}
      </div>
    </div>
